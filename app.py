...
def main():
    ...
    GDP = values = st.slider('GDP', 0.0, 2.0, (0.0))
    st.write('Values:', values)
    Family = values = st.slider('Family', 0.0, 2.0, (0.0))
    st.write('Values:', values)
    Health = values = st.slider('Health', 0.0, 2.0, (0.0))
    st.write('Values:', values)
    Freedom = values = st.slider('Freedom', 0.0, 2.0, (0.0))
    st.write('Values:', values)
    Corruption = values = st.slider('Corruption', 0.0, 2.0, (0.0))
    st.write('Values:', values)
    Generosity = values = st.slider('Generosity', 0.0, 2.0, (0.0))
    st.write('Values:', values)
